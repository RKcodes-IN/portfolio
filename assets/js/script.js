...
// Set your start date
var startDate = new Date('2019-04-11'); // Replace with your actual start date

// Calculate experience
var experience = calculateExperience(startDate);

// Append the experience to the HTML
$('#years').text(experience.years);
$('#months').text(experience.months);
$('#days').text(experience.days);
